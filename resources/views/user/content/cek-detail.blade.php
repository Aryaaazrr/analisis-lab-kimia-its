        ...
        <form action="{{ route('layanan.store') }}" method="POST">
            ...
            <div class=" p-6 mt-4 rounded-lg h-auto bg-slate-50" id="form">
                ...
                <div class="flex mb-4 flex-col rounded-md">
                    <div class="flex justify-evenly flex-row w-full">
                        <div class="flex mt-4 mr-2 w-full flex-col">
                            <label for="jumlah_sampel" class="mb-2 text-sm text-gray-900">Jumlah Sampel</label>
                            <input type="text" id="jumlah_sampel" name="jumlah_sampel" value="{{ $jumlahSampel }}"
                                readonly
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 duration-500">
                        </div>
                        <div class="flex mt-4 mr-2 w-full flex-col">
                            <label for="total_biaya" class="mb-2 text-sm text-gray-900">Total Biaya</label>
                            <input type="text" id="total_biaya" name="total_biaya" value="{{ $total_bayar }}"
                                readonly
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 duration-500">
                        </div>
                    </div>
                    <div class="flex justify-evenly flex-row w-full">
                        <div class="flex mt-4 mr-2 w-full flex-col">
                            <label for="jadwal" class="mb-2 text-sm text-gray-900">Tentukan Jadwal</label>
                        ...
                        <div class="flex mt-4 mr-2 w-full flex-col">
                            <label for="catatan" class="mb-2 text-sm text-gray-900">Catatan</label>
