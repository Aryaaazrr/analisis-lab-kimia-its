...
@section('content')
    <div class="p-10 -mt-4 sm:ml-64">
        ...
        <div class="p-4 mt-4 rounded-lg h-auto bg-slate-50">
            <form action="{{ route('layanan.step3.post') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex justify-evenly mt-4">
                    <div class="flex mt-4 mr-2 items-start w-full flex-col">
                        ...
                        class="bg-gray-50 border font-semibold border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 duration-500"
                        value="No Rek : 1673015902 BNI An. Riris Kurniarina" readonly>
                    </div>
                </div>
                <div class="flex justify-evenly mt-4">
                    <div class="flex mt-4 mr-2 items-start w-full flex-col">
                ...
                <div class="flex justify-evenly mt-4">
                    <div class="flex mt-4 mr-2 items-start w-full flex-col">
                        ...
                        <input type="text" id="status_pembayaran" name="status_pembayaran"
                            class="bg-gray-50 border border-gray-300 text-red-800 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 duration-500"
                            value="{{ $status_pembayaran[0] }}" readonly>
                    </div>
                    <div class="flex mt-4 ml-2 items-start w-full flex-col">
