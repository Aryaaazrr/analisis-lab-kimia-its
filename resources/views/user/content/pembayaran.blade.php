...
@section('content')
    <div class="p-10 mt-20 sm:ml-64">
        ...
        <div class="p-6 mt-4 rounded-lg h-auto bg-slate-50">
            ...
            <form action="{{ route('layanan.bayar', $transaksi->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="flex justify-evenly mt-4">
                    <div class="flex mt-4 mr-2 items-start w-full flex-col">
                        ...
                        <input type="text" id="disabled-input" aria-label="disabled input"
                            ...
                            value="{{ currency_IDR($transaksi->grand_total_transaksi) }}" disabled>
                    </div>
                    <div class="flex mt-4 ml-2 items-start w-full flex-col">
                ...
                <div class="flex justify-evenly mt-4">
                    <div class="flex mt-4 mr-2 items-start w-full flex-col">
                        ...
                        <input type="text" id="disabled-input" aria-label="disabled input"
                            ...
                            value="{{ $pembayaran_transaksi->status_pembayaran }}" disabled>
                    </div>
                    <div class="flex mt-4 ml-2 items-start w-full flex-col">
